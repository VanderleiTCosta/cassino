  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <div>
          <h3 className="flex items-center gap-2 text-lg font-bold text-cyan-400"><FaWifi /> IP de VPN Sugerido</h3>
          <div className="bg-gray-700 p-4 rounded-md mt-2">
            {isLoadingIp ? (
              ...
              suggestedIpInfo && (
                <div>
                  <p className="font-mono text-xl text-white">{suggestedIpInfo.ip}</p>
                  <p className="text-sm text-gray-400 mt-1">{suggestedIpInfo.message}</p>
                </div>
              )
            )}
          </div>
